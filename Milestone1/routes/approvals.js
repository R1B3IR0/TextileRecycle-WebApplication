...
// Aprova uma doação
router.put('/approve/:id', authentication.verifyLoginUser, donationController.approve); // Put ou Post?

// Rejeita uma doação
router.put('/reject/:id', authentication.verifyLoginUser, donationController.reject);  // Put ou Post?
